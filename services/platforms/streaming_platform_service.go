...
// func (t *StreamingPlatformService) getExistedUrls(logger logger.Logger, upcResults []platformContracts.UrlResultContainer) (map[int]platformData.PlatformReleaseUrl, error) {
...
// func (t *StreamingPlatformService) getUpcResultsFromPlatformers(platformerContainers []basePlatforms.PlatformerContainer, upcContainers []platformContracts.UpcContainer) []platforms.UrlResultContainer {
// 	upcResults := make([]platformContracts.UrlResultContainer, 0)
